...
function tweetsReducer(state = {areTweetsLoading: false}, action) {
  ...
  switch (action.type) {
    case REQUEST_TWEETS:
      return Object.assign({}, state, { areTweetsLoading: action.areTweetsLoading });

    case RECEIVE_TWEETS:
    case RECEIVE_ERROR:
      return Object.assign({}, state, defaultSortingAndFilteringOptions,
        { areTweetsLoading: action.areTweetsLoading, tweetsResponse : action.tweetsResponse });
